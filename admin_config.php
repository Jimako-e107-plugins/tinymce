...
if( !e107::isInstalled('tinymce'))
{
	e107::redirect('admin');
	exit();
}

$result = e107::lan('tinymce', true);


	class tinymce_admin extends e_admin_dispatcher
	{

		protected $modes = array(
			'main'	=> array(
				'controller' 	=> 'tinymce_ui',
				'path' 			=> null,
				'ui' 			=> 'tinymce_ui_form',
				'uipath' 		=> null
			),
	...
	class tinymce_ui extends e_admin_ui
	{

		protected $pluginTitle		= 'TinyMce4';
		protected $pluginName		= 'tinymce';
	...
	class tinymce_ui_form extends e_admin_form_ui
	{
